...
class SplashScreenRegister:
    ...
    def __init__(self):
        ...
        # button masuk (active)
        btn_m_path = "assets/masuk_inactive.png"
        ...
        """
        # Add logic (when clicked) here...
        ...
        """

        # button daftar (inactive)
        btn_d_path = "assets/daftar_active.png"
        ...
        font_size = 20
        font = "Jellee"
        self.greet_lbl = QLabel("Selamat Datang!", self.contentContainer)
        ...
        self.masuk_btn = QPushButton("DAFTAR", self.contentContainer)
